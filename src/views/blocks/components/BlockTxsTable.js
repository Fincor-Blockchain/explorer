...
const BlocksTransactionsTable = (props) => {
  const { txs, blockTxsLoading } = props;
                  ...
                  <TableCol>
                    <TdMain>
                      <BlockHeight>
                        ...
                        <SemiBoldText>{item.height}</SemiBoldText>
                      </BlockHeight>
                    </TdMain>
                  </TableCol>
                  <TableCol>
                    <TdMain>
                      <BlockHeight>
                        <TextLight>Transaction type</TextLight>
                        <SemiBoldText>Transfer</SemiBoldText>
                      </BlockHeight>
                    </TdMain>
                  </TableCol>
                  <TableCol>
                    <TdMain>
                      <BlockHeight>
                        <TextLight>Age</TextLight>
                        <SemiBoldText>{format(item.timestamp)}</SemiBoldText>
                      </BlockHeight>
                    </TdMain>
                  </TableCol>
                  <TableCol>
...
export default withRouter(BlocksTransactionsTable);
