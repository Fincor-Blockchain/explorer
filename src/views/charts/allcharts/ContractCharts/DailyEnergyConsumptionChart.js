...
`;
const HeadingEllipses = styled.h1`
...
`;
// Tooltip Styling
const DailyEnergyConsumptionChart = () => {
  ...
  return (
    ...
    >
      <HeadingBox>
        <HeadingRow>
          <HeadingEllipses>Daily Energy Consumption By</HeadingEllipses>
        </HeadingRow>
        <MoreWrapper>
...
export default DailyEnergyConsumptionChart;
